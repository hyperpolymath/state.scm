...
:experimental:
:url-github: https://github.com/hyperpolymath/STATE.scm
:url-gitlab: https://gitlab.com/hyperpolymath/STATE.scm
:url-bitbucket: https://bitbucket.org/hyperpolymath/STATE.scm
:url-codeberg: https://codeberg.org/hyperpolymath/STATE.scm

Guile STATE machine definitions
...
STATE.scm is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
